...
/**
 * Fetch neighborhoods, cuisines as soon as the page is loaded.
 * Also set the state of the hamburger menu
 */
 ...
 */
window.initMap = () => {
  let centreLocOfPlaces = {
    lat: 40.722216,
    lng: -73.987501
  };
  self.map = new google.maps.Map(document.getElementById("map"), {
    zoom: 12, //level of zoom that will fit all markers.
    center: centreLocOfPlaces,
    scrollwheel: false
  });
  updateRestaurants();
}
...
/*<------ Burger Menu Home Page Additions---->*/
...
/**
* If burger is click or enter is pressed it toggles the burger menu type with the selection boxes.
*/
...
/**
*If the viewport gets wider than 600px it reset selectors to open so the menus dont get lost if the burger menu is minimized.
*/
